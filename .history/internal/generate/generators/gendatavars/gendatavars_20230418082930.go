...
import (
	...
	. "github.com/golangast/groundup/internal/generate/templates/handler"
	. "github.com/golangast/groundup/internal/generate/templates/router"
...
func Gendatavars(p, urls, datavar string) {
	...
	*/
	...
	ErrorCheck(err)
	err = Writetemplate(Handlertemp, handlerfile, urldatavar)
	ErrorCheck(err)
	err = Writetemplate(Datavarstemp, gdatafile, nil)
	ErrorCheck(err)
	/*
		write to files
	*/
